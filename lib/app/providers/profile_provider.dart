...
final publicProfileProvider = FutureProvider.autoDispose
    .family<PublicProfileModel, String>((ref, username) {
...
final userSearchProvider = FutureProvider.autoDispose
    .family<List<UserSearchResultModel>, String>((ref, query) {
      final isChildProfile = ref.watch(
        authProvider.select((state) => state.activeProfile?.isChild ?? false),
      );
      final normalized = query.trim();
      if (normalized.length < 2 || isChildProfile) {
