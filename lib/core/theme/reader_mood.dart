...
/// Okuma ekraninda kaydirdikca degisen arka plan gradyanlari.
/// Her paragraf/sayfa farkli bir "mood" sunar; tekduzeligi kirar.
class ReaderMood {
  ReaderMood._();

  static const List<List<Color>> _gradients = [
    [Color(0xFF2D2520), Color(0xFF1C1815)], // Sicak kahve
    [Color(0xFF2A2438), Color(0xFF1A1625)], // Soft lavanta-gri
    [Color(0xFF252A2E), Color(0xFF161C1E)], // Gece mavisi
    [Color(0xFF24302A), Color(0xFF151D19)], // Orman yesili
    [Color(0xFF2E2622), Color(0xFF1F1916)], // Terracotta
    [Color(0xFF2B2826), Color(0xFF1A1816)], // Sicak komur
  ];
